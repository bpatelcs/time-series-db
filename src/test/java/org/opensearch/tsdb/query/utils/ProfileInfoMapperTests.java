...
public class ProfileInfoMapperTests extends OpenSearchTestCase {
    ...
    public void testExtractProfileInfo_WithValidDebugInfo() throws IOException {
        ...
        String expected = "{"
            ...
            + "\"query_time\":0,"
            + "\"fetch_time\":0,"
            + "\"network_inbound_time\":0,"
            + "\"network_outbound_time\":0,"
            + "\"initialize_time\":100,"
            + "\"collect_time\":200,"
            + "\"post_collection_time\":150,"
            + "\"build_aggregation_time\":300,"
            + "\"reduce_time\":250"
            + "},"
            + "\"debug_info\":{"
            + "\"total_chunks\":100,"
    ...
    public void testExtractProfileInfo_WithMultipleShards() throws IOException {
        ...
        String expected = "{"
            ...
            + "\"initialize_time\":200,"
            + "\"collect_time\":400,"
            + "\"post_collection_time\":300,"
            + "\"build_aggregation_time\":600,"
            + "\"reduce_time\":500"
            + "},"
            + "\"debug_info\":{"
            + "\"total_chunks\":300,"
    ...
    public void testExtractProfileInfo_WithNonTimeSeriesUnfoldAggregator() throws IOException {
        ...
        String expected = "{"
            ...
            + "\"initialize_time\":0,"
            + "\"collect_time\":0,"
            + "\"post_collection_time\":0,"
            + "\"build_aggregation_time\":0,"
            + "\"reduce_time\":0"
            + "},"
            + "\"debug_info\":{"
            + "\"total_chunks\":0,"
    ...
    private ProfileResult createProfileResult(String type, Map<String, Object> debugMap) {
        ...
        breakdown.put(ProfileInfoMapper.INITIALIZE_TIME, 100L);
        breakdown.put(ProfileInfoMapper.COLLECT_TIME, 200L);
        breakdown.put(ProfileInfoMapper.POST_COLLECTION_TIME, 150L);
        breakdown.put(ProfileInfoMapper.BUILD_AGGREGATION_TIME, 300L);
        breakdown.put(ProfileInfoMapper.REDUCE_TIME, 250L);
